...
if __name__ == '__main__':
    ...
    parser.add_argument("--metrics", type=str, default='DRB.UEThpDl,DRB.UEThpUl,DRB.AirIfDelayDist', help="Comma-separated list of Metrics names") # Added DRB.AirIfDelayDist to default
